...
void basic_function_test(){
	printf("*****************hello you just entered the personal testing unit ****************\n");


	//cache_t* test = createCache(2, 16, 128, "testFiles/50AddressTest.txt");
	// printf("%d\n", getTagSize(test));
	//printf("%d\n", getOffset(test,0x21));
	//printf("%d\n", getIndex(test,0x71));
	// printf("%d\n", getTag(test,0x201));
	// printf("%d\n", 	getBlockStartBits(test, 2));
	//printf("%d\n",getDirtyLocation(test,1));
	// getSharedLocation(cache_t* cache, uint32_t blockNumber)
	// getLRULocation(cache_t* cache, uint32_t blockNumber)
	//printf("%i\n",getTagLocation(test,0));
	//printf("%i\n",getDataLocation(test,0,1));
	//printf("%d\n", numLRUBits(test));
	//printCache(test);
